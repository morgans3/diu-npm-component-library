...
@NgModule({
  ...
  imports: [FormsModule, ReactiveFormsModule, MaterialModule, ImageUploaderModule, HttpClientModule, CommonModule, FlexLayoutModule, MDBBootstrapModule, NgxTwitterTimelineModule, GalleryModule],
  exports: [
    DiuComponentLibraryComponent,
    DynamicFormComponent,
    InputComponent,
