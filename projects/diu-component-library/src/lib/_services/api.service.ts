...
export class APIService extends BaseService {
  ...
  public syncCapabilitiesLink(link_id: string, link_type: string, capabilities?: number[]) {
    return this.http.post(this.baseUrl + "capabilities/links/sync", { link_id: link_id, link_type: link_type, capabilities: capabilities });
  }
  ...
  public deleteCapabilitiesLink(capability_id: number, link_id: string, link_type: string) {
    return this.http.delete(this.baseUrl + "capabilities/links/delete", { body: { capability_id: capability_id, link_id: link_id, link_type: link_type } });
  }
