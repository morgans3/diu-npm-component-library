...
@Component({
  ...
  template: `<div *ngFor="let s of sizes" fxHide [fxShow.xs]="s.name === 'xs'" [fxShow.sm]="s.name === 'sm'" [fxShow.md]="s.name === 'md'" [fxShow.lg]="s.name === 'lg'" [fxShow.xl]="s.name === 'xl'" class="{{ s.css + ' ' + (prefix + s.id) }}"></div>`,
})
